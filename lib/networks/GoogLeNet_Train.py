...
class GoogLeNet_Train(Network):
    ...
    def setup(self):
        ...
        #     .avg_pool(5, 5, 3, 3, name='loss1_ave_pool')
        #     .conv(1, 1, 128, 1, 1, name='loss1_conv')
        #     .fc(1024, relu=True, name='loss1_fc')
             #.dropout(0.7, name='loss1_drop_fc')
        #     .fc(self.n_classes, relu=False, name='loss1_classifier')
        #     )
        ...
        #     .avg_pool(5, 5, 3, 3, name='loss2_ave_pool')
        #     .conv(1, 1, 128, 1, 1, name='loss2_conv')
        #     .fc(1024, name='loss2_fc', relu='True')
             #.dropout(0.7, name='loss2_drop_fc')
        #     .fc(self.n_classes, name='loss2_classifier'))
        ...
        (self.feed('inception_5b_1x1',
             ...
             .dropout(keep_prob=self.keep_prob, name='pool5_drop_7x7_s1')
             .fc(self.n_classes, relu=False, name='loss3_classifier_new')
             .softmax(name='prob3'))
